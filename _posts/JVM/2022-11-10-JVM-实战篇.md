...
![](../../img/JVM_2.assets/20231106104013.png)



![](../../img/JVM_2.assets/20231106105719.png)



# 二、解决内存泄漏-监控-top命令

![](../../img/JVM_2.assets/20231106110004.png)
...
![](../../img/JVM_2.assets/20231106111205.png)

![](../../img/JVM_2.assets/20231106111226.png)
...
![](../../img/JVM_2.assets/20231106111554.png)
...
![](../../img/JVM_2.assets/20231106112038.png)

![](../../img/JVM_2.assets/20231106112115.png)

![](../../img/JVM_2.assets/20231106112214.png)

也可以在IDEA中安装visualvm启动插件

![](../../img/JVM_2.assets/20231106112452.png)

插件安装完成后，需要手动指定目录

![](../../img/JVM_2.assets/20231106112624.png)

![](../../img/JVM_2.assets/20231106112730.png)

此时IDEA界面上就会出现visualvm相关的按钮

![](../../img/JVM_2.assets/20231106112937.png)

jvisualvm也可以监控远程服务器

启动java程序需要增加一些参数

![](../../img/JVM_2.assets/20231106113207.png)

![](../../img/JVM_2.assets/20231106113347.png)

![](../../img/JVM_2.assets/20231106113435.png)
...
![](../../img/JVM_2.assets/20231106113758.png)

![](../../img/JVM_2.assets/20231106114042.png)

![](../../img/JVM_2.assets/20231106114147.png)
...
![](../../img/JVM_2.assets/20231106114614.png)

tunnel页面管理默认使用的端口号是8080

启动两个Java程序，注意端口号

![](../../img/JVM_2.assets/20231106115303.png)





![](../../img/JVM_2.assets/20231106115024.png)



![](../../img/JVM_2.assets/20231106115418.png)

![](../../img/JVM_2.assets/20231106115459.png)



# 五、解决内存泄漏-监控-Prometheus+ Grafana

![](../../img/JVM_2.assets/20231106141304.png)
...
![](../../img/JVM_2.assets/20231106142532.png)

![](../../img/JVM_2.assets/20231106142811.png)

![](../../img/JVM_2.assets/20231106142911.png)



# 六、解决内存泄漏-堆内存状况对比

![](../../img/JVM_2.assets/20231106143246.png)

# 七、内存泄漏产生的几大原因（代码问题）

![](../../img/JVM_2.assets/20231106143945.png)

## 1、equals和hashCode导致的内存泄漏

![](../../img/JVM_2.assets/20231106144055.png)
...
![](../../img/JVM_2.assets/20231106144701.png)

![](../../img/JVM_2.assets/20231106144928.png)

![](../../img/JVM_2.assets/20231106145013.png)

![](../../img/JVM_2.assets/20231106145109.png)
...
![](../../img/JVM_2.assets/20231106145609.png)
...
![](../../img/JVM_2.assets/20231106150431.png)
...
![](../../img/JVM_2.assets/20231106151813.png)
...
![](../../img/JVM_2.assets/20231106152436.png)

![](../../img/JVM_2.assets/20231106152549.png)

![](../../img/JVM_2.assets/20231106152620.png)

![](../../img/JVM_2.assets/20231106152749.png)



## 5、通过静态字段保存对象

![](../../img/JVM_2.assets/20231106152958.png)
...
![](../../img/JVM_2.assets/20231106153754.png)

# 八、产生内存溢出原因-并发请求问题

![](../../img/JVM_2.assets/20231106154436.png)

![](../../img/JVM_2.assets/20231106154528.png)

![](../../img/JVM_2.assets/20231106155151.png)

![](../../img/JVM_2.assets/20231106155257.png)

![](../../img/JVM_2.assets/20231106155334.png)

![](../../img/JVM_2.assets/20231106155629.png)

![](../../img/JVM_2.assets/20231106155728.png)

![](../../img/JVM_2.assets/20231106155930.png)

![](../../img/JVM_2.assets/20231106160037.png)
...
![](../../img/JVM_2.assets/20231106160942.png)

![](../../img/JVM_2.assets/20231106161045.png)

![](../../img/JVM_2.assets/20231106161045.png

![](../../img/JVM_2.assets/20231106161331.png)

此时会自动把函数复制到粘贴板中

![](../../img/JVM_2.assets/20231106161541.png)

![](../../img/JVM_2.assets/20231106161746.png)
...
![](../../img/JVM_2.assets/20231106162434.png)



![](../../img/JVM_2.assets/20231106162559.png)
...
![](../../img/JVM_2.assets/20231106163016.png)

打开mat工具，选择dump文件

![](../../img/JVM_2.assets/20231106163242.png)

![](../../img/JVM_2.assets/20231106163418.png)

![](../../img/JVM_2.assets/20231106163534.png)

![](../../img/JVM_2.assets/20231106163644.png)

![](../../img/JVM_2.assets/20231106163807.png)



![](../../img/JVM_2.assets/20231107091550.png)

![](../../img/JVM_2.assets/20231107091827.png)

![](../../img/JVM_2.assets/20231107092003.png)
...
![](../../img/JVM_2.assets/20231107092955.png)
...
![](../../img/JVM_2.assets/20231107092811.png)

![](../../img/JVM_2.assets/20231107092906.png)

![](../../img/JVM_2.assets/20231107093634.png)

# 十、导出运行中系统（还未溢出）的内存快照进行分析

![](../../img/JVM_2.assets/20231107093912.png)

![](../../img/JVM_2.assets/20231107094614.png)![](../../img/JVM_2.assets/20231107094731.png)

服务器上执行完命令后，会生成下面三个报告文件

![](../../img/JVM_2.assets/20231107095013.png)

下载解压第一份内存报告

![](../../img/JVM_2.assets/20231107095133.png)

打开Index.html页面，展示的内容和mat上看到的一样

![](../../img/JVM_2.assets/20231107095219.png)



# 十一、修复内容

![](../../img/JVM_2.assets/20231107095428.png)

## 1、查询大数据量导致的内存溢出

![](../../img/JVM_2.assets/20231107095613.png)

![](../../img/JVM_2.assets/20231107095637.png)

![](../../img/JVM_2.assets/20231107095717.png)

![](../../img/JVM_2.assets/20231107100345.png)

![](../../img/JVM_2.assets/20231107101453.png)



## 2、mybatis导致的内存溢出

![](../../img/JVM_2.assets/20231107102026.png)

分析hprof文件，查看直方图，按大小排序，发现前几个占用的大小比后面的高出很多

![](../../img/JVM_2.assets/20231107102214.png)

发现是tomcat线程，找到支配树，找到HandlerMethod方法，查看引用

![](../../img/JVM_2.assets/20231107102403.png)

![](../../img/JVM_2.assets/20231107102613.png)

![](../../img/JVM_2.assets/20231107103008.png)

![](../../img/JVM_2.assets/20231107103205.png)

## 3、导出大文件内存溢出

![](../../img/JVM_2.assets/20231107103430.png)

![](../../img/JVM_2.assets/20231107103528.png)

![](../../img/JVM_2.assets/20231107103738.png)

![](../../img/JVM_2.assets/20231107103821.png)
...
![](../../img/JVM_2.assets/20231107105055.png)
...
![](../../img/JVM_2.assets/20231107105712.png)

![](../../img/JVM_2.assets/20231107110303.png)

![](../../img/JVM_2.assets/20231107110847.png)

![](../../img/JVM_2.assets/20231107110947.png)

![](../../img/JVM_2.assets/20231107111050.png)
...
![](../../img/JVM_2.assets/20231107111323.png)

![](../../img/JVM_2.assets/20231107111942.png)

## 5、文章内容审核接口的内存溢出

![](../../img/JVM_2.assets/20231107141535.png)
...
![](../../img/JVM_2.assets/20231107142221.png)

![](../../img/JVM_2.assets/20231107142315.png)

![](../../img/JVM_2.assets/20231107142705.png)
...
![](../../img/JVM_2.assets/20231107142842.png)



![](../../img/JVM_2.assets/20231107143353.png)

![](../../img/JVM_2.assets/20231107143452.png)

![](../../img/JVM_2.assets/20231107143526.png)

![](../../img/JVM_2.assets/20231107143648.png)



![](../../img/JVM_2.assets/20231107143831.png)

然后jmeter调用接口，云服务器控制台就会出现UserEntity的方法

![](../../img/JVM_2.assets/20231107143934.png)

stack命令比较简单，如果要追踪比较复杂的问题，比如追踪的时候要打印参数等内容，就可以用btrace



![](../../img/JVM_2.assets/20231107144056.png)

![](../../img/JVM_2.assets/20231107144442.png)

![](../../img/JVM_2.assets/20231107144412.png)
...
![](../../img/JVM_2.assets/20231107145059.png)

![](../../img/JVM_2.assets/20231107145202.png)

![](../../img/JVM_2.assets/20231107145302.png)
...
![](../../img/JVM-基础篇.assets/20231013100059.png)
...
![](../../img/JVM-基础篇.assets/20231013095835.png)
...
![](../../img/JVM-基础篇.assets/20231013110029.png)

2.元信息验证，例如类必须有父类（super不能为空）。

![](../../img/JVM-基础篇.assets/20231013110105.png)

3.验证程序执行指令的语义，比如方法内的指令执行中跳转到不正确的位置。

![](../../img/JVM-基础篇.assets/20231013110134.png)
...
![](../../img/JVM-基础篇.assets/20231013110248.png)

#### 2.1.3 类的生命周期-连接阶段之准备

准备阶段为静态变量（static）分配内存并设置初始值。

![](../../img/JVM-基础篇.assets/20231013110401.png)

准备阶段只会给静态变量赋初始值，而每一种基本数据类型和引用数据类型都有其初始值

![](../../img/JVM-基础篇.assets/20231013110438.png)

final修饰的基本数据类型的静态变量，准备阶段直接会将代码中的值进行赋值

![](../../img/JVM-基础篇.assets/20231013110520.png)
...
![](../../img/JVM-基础篇.assets/20231013110637.png)

直接引用不在使用编号，而是使用内存中地址进行访问具体的数据。

![](../../img/JVM-基础篇.assets/20231013110723.png)

#### 2.1.5 类的生命周期-初始化阶段

![](../../img/JVM-基础篇.assets/20231013110847.png)

初始化阶段会执行**静态代码块中的代码**，并**为静态变量赋值**

初始化阶段会执行字节码文件中**clinit**部分的字节码指令

![](../../img/JVM-基础篇.assets/20231013110959.png)

![](../../img/JVM-基础篇.assets/20231013111044.png)

![](../../img/JVM-基础篇.assets/20231013111133.png)
...
![](../../img/JVM-基础篇.assets/20231013145204.png)

![](../../img/JVM-基础篇.assets/20231013145253.png)
...
![](../../img/JVM-基础篇.assets/20231013145529.png)
...
![](../../img/JVM-基础篇.assets/20231013151924.png)
...
![](../../img/JVM-基础篇.assets/20231013152220.png)
...
![](../../img/JVM-基础篇.assets/20231013154705.png)
...
![](../../img/JVM-基础篇.assets/20231013153059.png)

![](../../img/JVM-基础篇.assets/20231013153318.png)
...
![](../../img/JVM-基础篇.assets/20231013153454.png)

应用程序类加载器的parent父类加载器是扩展类加载器，而扩展类加载器的parent是空。

启动类加载器使用C++编写，没有上级类加载器。

![](../../img/JVM-基础篇.assets/20231013153632.png)
...
![](../../img/JVM-基础篇.assets/20231013154053.png)



![](../../img/JVM-基础篇.assets/20231013155316.png)
...
![](../../img/JVM-基础篇.assets/20231013155804.png)
...
- 如果不打破双亲委派机制，当应用类加载器加载Web应用1中的MyServlet之后，Web应用2中相同限定名的 MyServlet类就无法被加载了。
  ...
  ![](../../img/JVM-基础篇.assets/20231013160250.png)

![](../../img/JVM-基础篇.assets/20231013160313.png)

先来分析ClassLoader的原理，ClassLoader中包含了4个核心方法。

双亲委派机制的核心代码就位于loadClass方法中。

![](../../img/JVM-基础篇.assets/20231027111652.png)
...
![](../../img/JVM-基础篇.assets/20231027144807.png)

![](../../img/JVM-基础篇.assets/20231027144844.png)

![](../../img/JVM-基础篇.assets/20231027144911.png)

![](../../img/JVM-基础篇.assets/20231027144943.png)

DriverManager怎么知道jar包中要加载的驱动在哪儿？

![](../../img/JVM-基础篇.assets/20231027145053.png)

![](../../img/JVM-基础篇.assets/20231027145125.png)

SPI中是如何获取到应用程序类加载器的？

![](../../img/JVM-基础篇.assets/20231027145207.png)

![](../../img/JVM-基础篇.assets/20231027145235.png)

#### 2.4.3 打破双亲委派机制- OSGi模块化

![](../../img/JVM-基础篇.assets/20231027145622.png)

![](../../img/JVM-基础篇.assets/20231027145803.png)
...
![](../../img/JVM-基础篇.assets/20231027150515.png)

![](../../img/JVM-基础篇.assets/20231027150707.png)

![](../../img/JVM-基础篇.assets/20231027150749.png)
...
![](../../img/JVM-基础篇.assets/20231027151054.png)
...
![](../../img/JVM-基础篇.assets/20231027151136.png)
...
![](../../img/JVM-基础篇.assets/20231027151743.png)

![](../../img/JVM-基础篇.assets/20231027151846.png)

![](../../img/JVM-基础篇.assets/20231027152043.png)

![](../../img/JVM-基础篇.assets/20231027152055.png)

![](../../img/JVM-基础篇.assets/20231027152153.png)

### 3.1 程序计数器

程序计数器（Program Counter Register）也叫PC寄存器，每个线程会通过程序计数器记录当前要执行的的字 节码指令的地址

![](../../img/JVM-基础篇.assets/20231027152446.png)

![](../../img/JVM-基础篇.assets/20231027152522.png)

在加载阶段，虚拟机将字节码文件中的指令读取到内存之后，会将原文件中的偏移量转换成内存地址。每一条字 节码指令都会拥有一个内存地址。

![](../../img/JVM-基础篇.assets/20231027152705.png)
...
![](../../img/JVM-基础篇.assets/20231027153017.png)
...
![](../../img/JVM-基础篇.assets/20231027153815.png)



![](../../img/JVM-基础篇.assets/20231027153853.png)

eat方法执行完，弹出栈

![](../../img/JVM-基础篇.assets/20231027153935.png)

![](../../img/JVM-基础篇.assets/20231027154031.png)

sleep执行完后出栈

![](../../img/JVM-基础篇.assets/20231027154106.png)

study执行完后出栈

![](../../img/JVM-基础篇.assets/20231027154159.png)

main方法执行完后出栈

![](../../img/JVM-基础篇.assets/20231027154316.png)
...
![](../../img/JVM-基础篇.assets/20231027154809.png)

![](../../img/JVM-基础篇.assets/20231027155011.png)

Java虚拟机栈随着线程的创建而创建，而回收则会在线程的销毁时进行。由于方法可能会在不同线 程中执行，每个线程都会包含一个自己的虚拟机栈。

![](../../img/JVM-基础篇.assets/20231027155233.png)

##### 3.2.1.1  局部变量表

局部变量表的作用是在方法执行过程中存放所有的局部变量。编译成字节码文件时就可以确定局部变量表的内容。

![](../../img/JVM-基础篇.assets/20231027155628.png)
...
![](../../img/JVM-基础篇.assets/20231027160010.png)

![](../../img/JVM-基础篇.assets/20231027160152.png)

![](../../img/JVM-基础篇.assets/20231027160524.png)

![](../../img/JVM-基础篇.assets/20231027160655.png)

为了节省空间，局部变量表中的槽是可以复用的，一旦某个局部变量不再生效，当前槽就可以再次被使用。

![](../../img/JVM-基础篇.assets/20231027160832.png)

![](../../img/JVM-基础篇.assets/20231027160901.png)

![](../../img/JVM-基础篇.assets/20231027160927.png)

![](../../img/JVM-基础篇.assets/20231027161011.png)
...
![](../../img/JVM-基础篇.assets/20231027161736.png)

##### 3.2.1.3 帧数据

![](../../img/JVM-基础篇.assets/20231030093934.png)

当前类的字节码指令引用了其他类的属性或者方法时，需要将符号引用（编号）转换成对应的运行时常量池 中的内存地址。动态链接就保存了编号到运行时常量池的内存地址的映射关系。

![](../../img/JVM-基础篇.assets/20231030094024.png)

方法出口指的是方法在正确或者异常结束时，当前栈帧会被弹出，同时程序计数器应该指向上一个栈帧中的 下一条指令的地址。所以在当前栈帧中，需要存储此方法出口的地址。

![](../../img/JVM-基础篇.assets/20231030094138.png)

异常表存放的是代码中异常的处理信息，包含了异常捕获的生效范围以及异常发生后跳转到的字节码指令位置。

![](../../img/JVM-基础篇.assets/20231030094319.png)

![](../../img/JVM-基础篇.assets/20231030094551.png)
...
![](../../img/JVM-基础篇.assets/20231030095118.png)

##### 3.2.1.5 Java虚拟机栈 – 默认大小

如果我们不指定栈的大小，JVM 将创建一个 具有默认大小的栈。大小取决于操作系统和 计算机的体系结构。

![](../../img/JVM-基础篇.assets/20231030095441.png)

![](../../img/JVM-基础篇.assets/20231030095503.png)

![](../../img/JVM-基础篇.assets/20231030095613.png)
...
![](../../img/JVM-基础篇.assets/20231030100303.png)
...
- 在Hotspot虚拟机中，Java虚拟机栈和本地方法栈实现上使用了同一个栈空间。本地方法栈会在栈内 存上生成一个栈帧，临时保存方法的参数同时方便出现异常时也把本地方法的栈信息打印出来。
  ...
  ![](../../img/JVM-基础篇.assets/20231030100716.png)

![](../../img/JVM-基础篇.assets/20231030100653.png)
...
![](../../img/JVM-基础篇.assets/20231030101108.png)
...
![](../../img/JVM-基础篇.assets/20231030101313.png)
...
![](../../img/JVM-基础篇.assets/20231030101659.png)

- 随着堆中的对象增多，当total可以使用的内存即将不足时，java虚拟机会继续分配内存给堆

- 如果堆内存不足，java虚拟机就会不断的分配内存，total值会变大。total最多只能与max相等。

  ![](../../img/JVM-基础篇.assets/20231030102526.png)

![](../../img/JVM-基础篇.assets/20231030102458.png)
...
![](../../img/JVM-基础篇.assets/20231030105239.png)

方法区是用来存储每个类的基本信息（元信息），一般称之为InstanceKlass对象。在类的加载阶段完成。

![](../../img/JVM-基础篇.assets/20231030105416.png)
...
![](../../img/JVM-基础篇.assets/20231030105635.png)
...
![](../../img/JVM-基础篇.assets/20231030110118.png)
...
![](../../img/JVM-基础篇.assets/20231030111618.png)

字符串常量池和运行时常量池有什么关系？

早期设计时，字符串常量池是属于运行时常量池的一部分，他们存储的位置也是一致的。后续做出了调整， 将字符串常量池和运行时常量池做了拆分。

![](../../img/JVM-基础篇.assets/20231030111905.png)

![](../../img/JVM-基础篇.assets/20231030112324.png)

![](../../img/JVM-基础篇.assets/20231030112345.png)

![](../../img/JVM-基础篇.assets/20231030112646.png)



![](../../img/JVM-基础篇.assets/20231030112621.png)

![](../../img/JVM-基础篇.assets/20231030112716.png)
...
![](../../img/JVM-基础篇.assets/20231030142709.png)

- 要创建直接内存上的数据，可以使用ByteBuffer。
- 语法： ByteBuffer directBuffer = ByteBuffer.allocateDirect(size);
- 注意事项： arthas的memory命令可以查看直接内存大小，属性名direct。

![](../../img/JVM-基础篇.assets/20231030143308.png)

![](../../img/JVM-基础篇.assets/20231030143402.png)

![](../../img/JVM-基础篇.assets/20231030143443.png)
...
![](../../img/JVM-基础篇.assets/20231030144853.png)

![](../../img/JVM-基础篇.assets/20231030144916.png)

![](../../img/JVM-基础篇.assets/20231030144933.png)
...
![](../../img/JVM-基础篇.assets/20231030150207.png)
...
![](../../img/JVM-基础篇.assets/20231030150541.png)
...
![](../../img/JVM-基础篇.assets/20231030151211.png)

线程不共享的部分，都是伴随着线程的创建而创建，线程的销毁而销毁。而方法的栈帧在执行完方法之后就会 自动弹出栈并释放掉对应的内存。

![](../../img/JVM-基础篇.assets/20231030151449.png)

### 4.5 方法区的回收

![](../../img/JVM-基础篇.assets/20231030151608.png)
...
![](../../img/JVM-基础篇.assets/20231030151802.png)

2、加载该类的类加载器已经被回收。

![](../../img/JVM-基础篇.assets/20231030151831.png)

3、该类对应的 java.lang.Class 对象没有在任何地方被引用。

![](../../img/JVM-基础篇.assets/20231030151908.png)
...
![](../../img/JVM-基础篇.assets/20231030152929.png)

![](../../img/JVM-基础篇.assets/20231030152850.png)
...
![](../../img/JVM-基础篇.assets/20231030154141.png)

![](../../img/JVM-基础篇.assets/20231030154243.png)

![](../../img/JVM-基础篇.assets/20231030154348.png)
...
![](../../img/JVM-基础篇.assets/20231030154605.png)
...
![](../../img/JVM-基础篇.assets/20231030155025.png)

哪些对象被称之为GC Root对象呢？

- 线程Thread对象。引用线程栈帧中的方法参数、局部变量等。

  ![](../../img/JVM-基础篇.assets/20231030163249.png)

  ![](../../img/JVM-基础篇.assets/20231030163326.png)

- 系统类加载器加载的java.lang.Class对象。引用类中的静态变量。

  ![](../../img/JVM-基础篇.assets/20231030163512.png)

- 监视器对象，用来保存同步锁synchronized关键字持有的对象。

  ![](../../img/JVM-基础篇.assets/20231030163700.png)
...
![](../../img/JVM-基础篇.assets/20231030163929.png)
...
![](../../img/JVM-基础篇.assets/20231030165258.png)
...
![](../../img/JVM-基础篇.assets/20231031093601.png)

软引用的使用场景-缓存

软引用也可以使用继承自SoftReference类的方式来实现，StudentRef类就是一个软引用对象。 通过构造器传入软引用包含的对象，以及引用队列。

![](../../img/JVM-基础篇.assets/20231031093736.png)

![](../../img/JVM-基础篇.assets/20231031093854.png)
...
![](../../img/JVM-基础篇.assets/20231031095127.png)
...
![](../../img/JVM-基础篇.assets/20231031100019.png)
...
![](../../img/JVM-基础篇.assets/20231031100243.png)
...
![](../../img/JVM-基础篇.assets/20231031101912.png)
...
![](../../img/JVM-基础篇.assets/20231031102542.png)
...
![](../../img/JVM-基础篇.assets/20231031102152.png)
...
![](../../img/JVM-基础篇.assets/20231031102349.png)
...
![](../../img/JVM-基础篇.assets/20231031103540.png)
...
![](../../img/JVM-基础篇.assets/20231031103805.png)
...
![](../../img/JVM-基础篇.assets/20231031105827.png)
...
![](../../img/JVM-基础篇.assets/20231031111612.png)
...
![](../../img/JVM-基础篇.assets/20231031120519.png)
...
![](../../img/JVM-基础篇.assets/20231031120728.png)

![](../../img/JVM-基础篇.assets/20231031120820.png)
...
![](../../img/JVM-基础篇.assets/20231031121006.png)
...
![](../../img/JVM-基础篇.assets/20231031121458.png)
...
![](../../img/JVM-基础篇.assets/20231031121651.png)

![](../../img/JVM-基础篇.assets/20231031121712.png)
...
![](../../img/JVM-基础篇.assets/20231031122057.png)

![](../../img/JVM-基础篇.assets/20231031122115.png)
...
![](../../img/JVM-基础篇.assets/20231031123017.png)

![](../../img/JVM-基础篇.assets/20231031123046.png)

Parallel Scavenge允许手动设置最大暂停时间和吞吐量。

Oracle官方建议在使用这个组合时，不要设置堆内存 的最大值，垃圾回收器会根据最大暂停时间和吞吐量 自动调整内存大小。

![](../../img/JVM-基础篇.assets/20231031124106.png)
...
![](../../img/JVM-基础篇.assets/20231031123432.png)

![](../../img/JVM-基础篇.assets/20231031123449.png)
...
![](../../img/JVM-基础篇.assets/20231031141402.png)
...
![](../../img/JVM-基础篇.assets/20231031141809.png)
...
![](../../img/JVM-基础篇.assets/20231031142056.png)
...
![](../../img/JVM-基础篇.assets/20231031142451.png)

最后清理阶段使用复制算法，不会产生内存碎片。

![](../../img/JVM-基础篇.assets/20231031142703.png)

**G1垃圾回收器 – FULL GC**

注意：如果清理过程中发现没有足够的空Region存放转移的对象，会出现Full GC。单线程执行标记-整理算法， 此时会导致用户线程的暂停。所以尽量保证应该用的堆内存有一定多余的空间。

![](../../img/JVM-基础篇.assets/20231031142811.png)

参数1： -XX:+UseG1GC 打开G1的开关， JDK9之后默认不需要打开 

参数2：-XX:MaxGCPauseMillis=毫秒值  最大暂停的时间

![](../../img/JVM-基础篇.assets/20231031142913.png)
...
![](../../img/JVM-基础篇.assets/20231031143628.png)
...
![](../../img/JVM-基础篇.assets/20231031144015.png)

![](../../img/JVM-基础篇.assets/20231031144057.png)

![](../../img/JVM-基础篇.assets/20231031144215.png)

![](../../img/JVM-基础篇.assets/20231031144240.png)